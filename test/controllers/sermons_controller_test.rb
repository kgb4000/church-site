...
class SermonsControllerTest < ActionController::TestCase
  ...
  test "should create sermon" do
    assert_difference('Sermon.count') do
      post :create, sermon: { description: @sermon.description, scripture: @sermon.scripture, title: @sermon.title }
    end
  ...
  test "should update sermon" do
    patch :update, id: @sermon, sermon: { description: @sermon.description, scripture: @sermon.scripture, title: @sermon.title }
    assert_redirected_to sermon_path(assigns(:sermon))
  end
